...
'ASML.AS', 'SAUS.SW', 'BAS.DE', 'BATS.L', 'CANCDA.SW', 'CAT', 'EMSN.SW', 
...
# - Min) #ECART TYPE NORMALISE    =/=    COEFFICIENT DE VARIATION = sigma/Av
		#print(Av, sigma, ETN)
			Croiss.append([i, round(LastV - PrelastV, 5),"day0 - day-1,       ", DENDTXT, LastV, PrelastV,  round((LastV - PrelastV)*100/(LastV), 5), "%,       ", round(Pond, 4), "ponderation"]) #Symbole, difference dans la journee, % de gain/perte, ecart type
...
Ratio(Symb_INDUSTRIEL, 0.55, 5, 2)#, 0.8)

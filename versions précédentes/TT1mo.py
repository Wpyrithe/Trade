  ...
  "PBF", "CTRA", "0386.HK", "VLO", "PSX", "EQNR.OL", "AMR", "TELL", "VTS", "CPE", "VTLE",
   "MPC", "ARCH", "MTDR", "E", "EC", "SWN", "1088.HK", "WHC.AX", "WDS", "HES", "PGS.OL",
    "TLW.L", "EQNR", "MGY", "CNX", "APA", "DINO", "SM", "NFG", "CHK", "NOG.L", "CVI", 
     "CIVI", "TTE", "CEIX", "WTI", "ERF", "KOS", "1898.HK", "1171.HK", "BP",
    ...
    "HMY", "GFI", "CLF", "0914.HK", "PKX", "AU", "TS", "CDE", "ACX.MC", "UMI.BR", "CMC", "SSRM",
     "SLCA", "AGI", "VK.PA", "HOC.L", "HL", "ANTO.L", "SID", "NK.PA", "EXK", "HOLNZ.XC", "MT",
      "CRH.L", "VMC", "KNF", "IBST.L", "0MKX.IL", "EGO", "RGLD", "APAM.AS", "ATI", "BZU.MI", "FLS.CO",
       "MSLH.L", "MHK", "RHIM.L", "SUM", "EXP", "TKTT.PA"]
...
def Ratio(X, inf, H, h):#, sup):
	for i in X:
		...
		data = yf.Ticker(i)
		df = round(data.history(period="1mo"), 4)
		#print(df)
		L = len(df.index)
		#print(L)
		...
		#print(Decr10j)
		if (C/L > inf and Decr10j<inf*(1/3)*L): #() # and (Dend < 3):# and (C/L < sup): # Lim Sup a introduire? si C/L trop élevé ; chances de décroissance
		#print(df)
...
# - Min) #ECART TYPE NORMALISE    =/=    COEFFICIENT DE VARIATION = sigma/Av
		#print(Av, sigma, ETN)
			Croiss.append([i, "            ", DENDTXT, "       ", round(Pond, 4), "ponderation        ", Decr10j, "Decr10j"]) #Symbole, difference dans la journee, % de gain/perte, ecart type
		...
		#print(Croiss)
			...
			""""""#print("Pas assez croissante", i, round(C/L, 3), "C/L     ", Decr10j, "Decr10j")
